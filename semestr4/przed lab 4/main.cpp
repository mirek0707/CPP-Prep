...
int main()
{
...

    {
        ...
        if (smart1)
            std::cout << "...Nie powinno byc widoczne: " << smart1->info() << std::endl;
        if (smart2)
            std::cout << "...To powinno byc widoczne: " << smart2->info() << std::endl;
        ...
        if (smart2)
            std::cout << "...Nie powinno byc widoczne: " << smart2->info() << std::endl;
